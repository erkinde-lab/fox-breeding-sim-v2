...
export function Button({
  ...
  const variants = {
    default:
      "bg-primary text-primary-foreground hover:opacity-90 shadow-btn-primary",
    destructive:
      "bg-destructive text-destructive-foreground hover:opacity-90 shadow-lg shadow-black/20",
    outline:
      "border-2 border-border bg-transparent text-foreground hover:bg-muted",
    secondary:
      "bg-secondary text-secondary-foreground hover:opacity-90 shadow-btn-secondary",
    ghost: "hover:bg-muted text-foreground",
    link: "text-primary underline-offset-4 hover:underline font-bold",
    folk: "bg-primary text-primary-foreground hover:bg-primary/80 shadow-btn-primary",
    success:
      "bg-success text-success-foreground hover:opacity-90 shadow-lg shadow-black/20",
    warning:
      "bg-warning text-warning-foreground hover:opacity-90 shadow-lg shadow-black/20",
  ...
  const sizes = {
    default:
      "h-12 px-8 py-3 text-sm rounded-full font-bold uppercase tracking-widest",
