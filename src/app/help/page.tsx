...
const loci = [
  ...
  },
  {
    ...
    effect: 'gg produces a warm, reddish-brown dilution called Burgundy. When combined with Pearl (pp), it creates the Amber phenotype.',
  },
  {
    key: 'P',
    name: 'Pearl (P)',
    alleles: 'P (dominant) / p (recessive)',
    effect: 'pp creates the Pearl phenotype — a soft, pale coat with reduced pigment intensity. Pearl interacts with Burgundy to produce Amber combinations. On a pure Red base, Pearl expression is masked.',
  },
  {
    key: 'Fire',
    name: 'Fire Factor (Fire)',
    alleles: 'FI (dominant) / fi (recessive)',
    effect: 'fifi (homozygous) produces the Fire Factor — a striking orange-gold flush of color across the coat, most visible on silver and cross bases. The resulting phenotype depends on the base: Wildfire (Red), Golden Sunrise (Gold), Colicott (Double/Alaskan Silver), Fire Cross (Cross bases).',
  },
  {
    key: 'W',
    ...
    health: 'Homozygous white alleles (WW, WPWP, WGWG) and inter-dominant combinations of W, WP, and WG are lethal — kits do not survive. Marble (WM) is non-lethal in all combinations. Always breed white-marked foxes carefully to avoid lethal pairings.',
  ...
  },
  {
    ...
    effect: 'll (homozygous recessive) produces a white coat with blue eyes — the Leucistic phenotype. Unlike Albino, pigment cells are present but non-functional in the skin, so eye color can be blue or grey. Leucism masks base coat colors but allows White Markings to express.',
