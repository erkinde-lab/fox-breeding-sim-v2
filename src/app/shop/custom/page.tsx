            ...
            <Card className="border-primary/20 shadow-xl overflow-hidden border-2 rounded-[32px]">
                ...
                <CardContent className="p-8 space-y-12">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 items-stretch bg-muted p-8 rounded-3xl border border-border shadow-inner">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center bg-card rounded-2xl border border-border shadow-sm p-8 min-h-[250px] relative">
                            <div className="absolute top-4 left-4">
                                <Badge className="bg-primary/10 text-primary font-bold border-none uppercase tracking-tighter text-[10px]">{customGender}</Badge>
                            </div>
                            <FoxIllustration
                    ...
                    <div className="pt-8 border-t-2 border-border flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="text-muted-foreground text-sm max-w-md font-medium">
