...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
      <div className="p-6 bg-accent/10 rounded-full text-accent">
        <Award size={48} />
      </div>
      ...
      <Link href="/">
        <Button variant="default" className="bg-fire-600 hover:bg-fire-500 text-primary-foreground font-bold px-8">
          Back to Dashboard
        </Button>
      </Link>
    </div>
