    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
           <h3 className="text-xl font-black italic text-foreground flex items-center gap-3 tracking-tight">
                   ...
                   <Card key={fox.id} className="folk-card border-2 border-border shadow-sm rounded-3xl hover:border-primary/40 hover:shadow-lg transition-all">
                      <CardContent className="p-6 flex items-center gap-4">
                         ...
                         <div className="flex-1">
                            <h4 className="font-black italic text-lg text-foreground tracking-tight truncate">{fox.name}</h4>
