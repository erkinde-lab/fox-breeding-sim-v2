  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      <div>
        ...
        <p className="text-muted-foreground font-medium italic">Evaluate potential pairings and manage your nursery.</p>
      </div>
             ...
             <Card className="folk-card border-2 border-secondary/20 bg-secondary/5 shadow-2xl shadow-secondary/5 rounded-[40px] h-full overflow-hidden">
                <CardContent className="p-10 space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 bg-background/50 backdrop-blur-md rounded-[32px] border border-secondary/10 shadow-inner text-center">
                      <p className="text-[10px] font-black text-secondary uppercase mb-3 tracking-[0.2em]">Predicted Inbreeding (COI)</p>
                      <div className="flex items-baseline justify-center gap-1">
                        <span className="text-5xl font-black text-foreground tabular-nums tracking-tighter">{outcomes.predictedCOI}</span>
